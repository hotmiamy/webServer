...
# Headers
HEADER		:=	master.hpp ListeningSocket.hpp ConnectingSocket.hpp BindingSocket.hpp SimpleSocket.hpp
H_INCLUDE	:=	$(addprefix , $(HEADER))

# Source
SRC			:=	main.cpp ListeningSocket.cpp ConnectingSocket.cpp BindingSocket.cpp SimpleSocket.cpp
# Object
OBJ_DIR		:=	obj
