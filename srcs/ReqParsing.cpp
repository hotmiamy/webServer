...
void ReqParsing::parsePath(std::string path, const ServerConfig &conf) {
    ...
    if (std::ifstream(rootServer.data()).good()) {
        ...
        } else if (!ContentFormat(ServerUtils::getExtension(path)).empty()) {
